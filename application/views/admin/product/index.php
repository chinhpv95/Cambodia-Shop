        ...
        <table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="sTable mTable myTable">
            ...
            <?php foreach ($list as $row):?>
                <tr class="row_<?php echo $row->productCode?>">
                    <td><input type="checkbox" value="<?php echo $row->productCode?>" name="id[]"></td>
                    ...
                    <td class="option textC">
                        ...
                        <a class="tipS" title="Chỉnh sửa" href="<?php echo admin_url('product/edit/'.$row->productCode)?>">
                            <img src="<?php echo public_url('admin/images')?>/icons/color/edit.png">
                        </a>

                        <a class="tipS verify_action" title="Xóa" href="<?php echo admin_url('product/del/'.$row->productCode)?>">
