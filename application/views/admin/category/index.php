...
<!--					<td style="width:80px;">Thư tự hiện thị</td>-->
			...
			<tr class="row_<?php echo $row->categoryID?>">
						<td><input type="checkbox" name="id[]" value="<?php echo $row->categoryID?>" /></td>
						
						<td class="textC"><?php echo $row->categoryID?></td>
<!--                        <td class="textC">--><?php //echo $row->sort_order?><!--</td>-->
                        
						<td>
						<span title="<?php echo $row->categoryName?>" class="tipS">
						...
						<td class="option">
							...
							<a href="<?php echo admin_url('category/delete/'.$row->categoryID)?>" title="Xóa" class="tipS verify_action" >
