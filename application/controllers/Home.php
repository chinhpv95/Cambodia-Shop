...
Class Home extends MY_Controller
{
    ...
    //load ra thu vien phan trang
        ...
        $config['base_url']   = 'http://localhost/Project/home/index/'; //link hien thi ra danh sach san pham
    ...
    function sort($sort){
        ...
        $config = array();
        $config['total_rows'] = $total_rows;//tong tat ca cac san pham tren website
        $config['base_url']   = 'http://localhost/Project/home/sort/'.$sort; //link hien thi ra danh sach san pham
        $config['per_page']   = 12;//so luong san pham hien thi tren 1 trang
        ...
        $this->data['total_items']  =$total_items;
        //pre($config['per_page']);
        $this->data['temp'] = 'site/home/sort_view';
        $this->load->view('site/layout', $this->data);
    }
